<template>
    <v-container fluid class="main-page" height="100%">
        ...
        <br>
        <v-row justify="center">
            <v-btn to="/datall/about-us" color="rgba(204, 204, 204,0.2)" height="100" class="font-xlarge font"><span class="font">About
                    Us</span></v-btn>
        </v-row>
        <br>
        <br>
        <v-row justify="center">
            <v-btn color="rgba(204, 204, 204,0.2)" height="100" :to="{ name: 'datall-product' }"
                class="font-xlarge font"><span class="font">Our Product</span>
            </v-btn>
        </v-row>
        <br>
        <br>
        ...
        <v-row justify="end" class="bot-row">
            ...
            <v-card  height="100" width="100" class="qr mt-3"/>
        </v-row>
        <v-dialog v-model="qr" width="500">
            <v-card width="500" height="500" color="red" class="qr"></v-card>
        </v-dialog>
    </v-container>
</template>
<script>
...
import narganAcademyIcon from '~/components/svg/datallIcon.vue'
export default {
    components: { backIcon },
    name: 'datall',
    components: {
...
<style scoped>
.main-page {
    background-image: url(~/assets/datallpage.png);
...
.qr{
    background-image: url(~/assets/qr/DatallQrCode.png);
    background-repeat: no-repeat;
    background-size: 100% 100%;
}
</style>